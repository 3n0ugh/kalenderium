...
func New(s calendar.Service) Set {
	return Set{
...
func MakeCreateEventEndpoint(s calendar.Service) endpoint.Endpoint {
...
// format, invoke the service and return the response structure
func MakeListEventEndpoint(s calendar.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
...
// format, invoke the service and return the response structure
func MakeDeleteEventEndpoint(s calendar.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
...
// format, invoke the service and return the response structure
func MakeServiceStatusEndpoint(s calendar.Service) endpoint.Endpoint {
	return func(ctx context.Context, request interface{}) (interface{}, error) {
